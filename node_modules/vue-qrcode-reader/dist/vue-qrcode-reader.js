import { defineComponent as jt, ref as we, watch as We, onMounted as vo, onUnmounted as yo, computed as Ut, openBlock as Lt, createElementBlock as Ht, createElementVNode as at, normalizeStyle as go, withDirectives as wo, vShow as bo, renderSlot as Dr, withModifiers as ot } from "vue";
var Mr = (r, o, i) => {
  if (!o.has(r))
...
], _o = [...Ar, ["unknown"]].map((r) => r[0]), st = new Map(
  Ar
);
function So(r) {
  for (const [o, i] of st)
...
var dt = (() => {
  ...
  return function(o = {}) {
    ...
    var U, W = !1, R, A, X, k, D, M, le, ie;
    function be() {
      var e = U.buffer;
      i.HEAP8 = R = new Int8Array(e), i.HEAP16 = X = new Int16Array(e), i.HEAPU8 = A = new Uint8Array(e), i.HEAPU16 = k = new Uint16Array(e), i.HEAP32 = D = new Int32Array(e), i.HEAPU32 = M = new Uint32Array(e), i.HEAPF32 = le = new Float32Array(e), i.HEAPF64 = ie = new Float64Array(e);
    }
    var Ce = [], Oe = [], De = [];
    function Le() {
      if (i.preRun)
    ...
    var vt = "data:application/octet-stream;base64,", Be = (e) => e.startsWith(vt), fe;
    ...
    var K = new nr(), Mt = (e) => {
      ...
      t === 2 ? (a = ua, s = la, d = da, u = () => k, f = 1) : t === 4 && (a = fa, s = ha, d = pa, u = () => M, f = 2), re(e, {
        ...
        toWireType: (m, w) => {
          ...
          return M[T >> 2] = _ >> f, s(w, T + 4, _ + t), m !== null && m.push(ue, T), T;
        },
        argPackAdvance: ne,
        readValueFromPointer: $t,
      ...
      return a.length && (M[t >> 2] = ce.toHandle(a)), s;
    }, Ea = (e, t, n) => {
...
`,
    ...
    var Ga = {
      ...
      ga: La,
      S: za
    }, z = on(), ue = i._free = (e) => (ue = i._free = z.ka)(e), Ft = i._malloc = (e) => (Ft = i._malloc = z.la)(e), dr = (e) => (dr = z.na)(e), j = (e, t) => (j = z.oa)(e, t), Ue = (e) => (Ue = z.pa)(e), B = () => (B = z.qa)(), V = (e) => (V = z.ra)(e), fr = (e) => (fr = z.sa)(e), hr = (e) => (hr = z.ta)(e), pr = (e, t, n) => (pr = z.ua)(e, t, n), mr = (e) => (mr = z.va)(e);
    ...
    function yr() {
      if (te > 0 || (Le(), te > 0))
        return;
      function e() {
        rt || (rt = !0, i.calledRun = !0, !W && (ft(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), ht()));
      }
...
async function ei(r) {
  if (window.BarcodeDetector === void 0)
    return console.debug("[vue-qrcode-reader] Native BarcodeDetector not supported. Will use polyfill."), new ut({ formats: r });
  const o = await window.BarcodeDetector.getSupportedFormats(), i = r.filter((c) => !o.includes(c));
  return i.length > 0 ? (console.debug(`[vue-qrcode-reader] Native BarcodeDetector does not support formats ${JSON.stringify(i)}. Will use polyfill.`), new ut({ formats: r })) : (console.debug("[vue-qrcode-reader] Will use native BarcodeDetector."), new window.BarcodeDetector({ formats: r }));
}
async function Nr(r) {
  qr = await ei(r);
}
...
}, zr = async (r, o = ["qr_code"]) => await new ut({ formats: o }).detect(r), ni = async (r, o = ["qr_code"]) => {
  const i = new ut({ formats: o }), c = await ri(r);
...
oe.shimAudioContext = xi;
oe.shimCallbacksAPI = Ei;
oe.shimConstraints = rn;
oe.shimCreateOfferLegacy = Ai;
var _i = oe.shimGetUserMedia = Oi;
oe.shimLocalStreamsAPI = Pi;
oe.shimRTCIceServerUrls = Di;
oe.shimRemoteStreamsAPI = Ti;
...
const Fi = /* @__PURE__ */ jt({
  ...
  setup(r, { emit: o }) {
    ...
    We(
      ...
      async (k) => {
        ...
        if (ae(le !== null, "if cavnas is defined, canvas 2d context should also be non-null"), k.shouldStream) {
          it(), p.value = !1;
          try {
            const ie = await Ii(D, k);
            C.value ? (p.value = !0, c("camera-on", ie)) : await it();
          } catch (ie) {
            c("error", ie);
          }
        } else
          M.width = D.videoWidth, M.height = D.videoHeight, le.drawImage(D, 0, 0, D.videoWidth, D.videoHeight), it(), p.value = !1, c("camera-off");
      },
      { deep: !0 }
    ), We(h, async (k) => {
      C.value && await Nr(k);
    ...
    const F = (k) => {
      ...
      ae(D !== null, "canvas 2d context should always be non-null"), D.clearRect(0, 0, k.width, k.height);
    }, U = (k) => {
      const D = g.value;
      ae(
        D !== void 0,
      ...
      if (ae(
        ...
        const le = M.offsetWidth, ie = M.offsetHeight, be = M.videoWidth, Ce = M.videoHeight, Oe = Math.max(le / be, ie / Ce), De = be * Oe, Le = Ce * Oe, ft = De / be, ht = Le / Ce, pt = (le - De) / 2, mt = (ie - Le) / 2, Me = ({ x: de, y: Z }) => ({
          x: Math.floor(de * ft),
          y: Math.floor(Z * ht)
        }), te = ({ x: de, y: Z }) => ({
          x: Math.floor(de + pt),
          ...
          const { boundingBox: Z, cornerPoints: vt } = de, { x: Be, y: fe } = te(
            Me({
              x: Z.x,
              y: Z.y
            })
          ...
          return {
            ...de,
            cornerPoints: vt.map((qe) => te(Me(qe))),
            boundingBox: DOMRectReadOnly.fromRect({ x: Be, y: fe, width: Ve, height: yt })
          };
        });
